...
def apply_clahe_folder(input_folder, output_folder, clip_limit=2.0, tile_size=(8,8)):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith('.jpeg') or filename.endswith('.png') or filename.endswith('.tiff') or filename.endswith('.jpg'):  # Only process image files
            ...
            img = cv2.imread(input_path,cv2.IMREAD_GRAYSCALE) #cv2.IMREAD_GRAYSCALE
...
apply_clahe_folder('C:\\Users\\mkhan\\Desktop\\musabi\\OCT_project\\data\\oct\\oct_artelus\\val\\7', 'C:\\Users\\mkhan\\Desktop\\musabi\\OCT_project\\data\\oct\\oct_artelus\\val_clahe\\77\\')
