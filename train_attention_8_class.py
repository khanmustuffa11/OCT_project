...
with strategy.scope():
    ...
    del conv_base
    #model.load_weights("C:/Users/mkhan/Desktop/musabi/OCT_project/attention_model_new/attention_003--0.611094--0.947615--0.629917--0.934787.h5", by_name=True, skip_mismatch = True)
    model.summary()
